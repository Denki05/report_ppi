...
@section('content')
          ...
          <div class="container-xl">
            ...
            @csrf
              <div class="card-header">
                <h3 class="card-title">Report Customer Order :</h3>
              </div>
              <div class="card-body">
                <div class="mb-3 row">
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="col">
                      <select type="text" class="form-select" placeholder="Select Customer" id="select_customer" value="" name="select_customer[]" multiple>
                        <option value="">Select Customer</option>
                        @foreach($customer as $key)
                          <option value="{{ $key->customer_store_name }}">{{ $key->customer_store_name }}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                  <div class="mb-3 row">
                    ...
                    <div class="col">
                      <label class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="radios-inline" id="customer_summary" value="1">
                        <span class="form-check-label">Customer Summary</span>
                      </label>
                      <label class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="radios-inline" id="customer_detail_variant" value="2">
                        <span class="form-check-label">Customer Detail - Variant</span>
                      </label>
                      <label class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="radios-inline" id="customer_detail_bulan" value="3">
                        <span class="form-check-label">Customer Detail - Bulan</span>
                      </label>
                    </div>
                  </div>
                </div>
    ...
    <script type="text/javascript">
      ...
      document.addEventListener("DOMContentLoaded", function () {
        var el;
        window.TomSelect && (new TomSelect(el = document.getElementById('select_customer'), {
      ...
      $('#printReport').on('click', function(e) {
        ...
        $.ajax({
           type:'POST',
           url:"{{ route('customer.print_customer_report') }}",
           data:{"_token": "{{ csrf_token() }}","customer":customer, "start":start, "end":end, "type":typeReport},
