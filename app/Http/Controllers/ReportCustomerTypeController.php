...
class ReportCustomerTypeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('report_customer_type.index', compact('report'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $data = DB::table('tbl_sales_invoice')
            ->select( DB::Raw('SUM(tbl_sales_invoice_item.invoice_item_qty) AS invoice_qty'), 
                ...
                DB::Raw('(tbl_sales_invoice.invoice_subtotal - tbl_sales_invoice.invoice_disc_amount - tbl_sales_invoice.invoice_disc_amount2) AS invoice_purchase'), 
